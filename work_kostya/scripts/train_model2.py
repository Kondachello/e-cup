...
np.save("/root/work/Xval3_379.npy", Xv)
json.dump(names, open("/root/work/feat_names3.json", "w"))
...
for seed in SEEDS:
    ...
    reg.save_model(f"/root/work/m2_reg_s{seed}.txt")
    ...
    clf.save_model(f"/root/work/m2_clf_s{seed}.txt")
    ...
    size.save_model(f"/root/work/m2_size_s{seed}.txt")
...
np.save("/root/work/m2_val_pz.npy", pz); np.save("/root/work/m2_val_two.npy", two)
np.save("/root/work/m2_val_p.npy", p); np.save("/root/work/m2_val_s.npy", s)
