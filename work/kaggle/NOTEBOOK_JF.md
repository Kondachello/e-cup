...
MAX_STEPS = 12000    # ~5-5.5 ч/сид на T4 — гарантированно внутри 9 ч Save & Run All
...
## Чеклист владельца аккаунта (руками, сверху вниз)

| # | шаг | время |
|---|-----|-------|
| 1 | дождаться в очереди `tabexport_wed` (zip готов) и смоуков 255-262 (все exit=0) | проверка 1 мин |
| 2 | `bash work/kaggle/make_bundle3.sh`; ozon-code → New Version → `/tmp/jf_bundle.zip` | ~2 мин |
| 3 | New Dataset **ozon-tabfeats-wed** ← `work/data/kaggle_session3/kaggle_tabfeats_wed_v1.zip` | ~10-30 мин (аплоад 1.25 ГБ) |
| 4 | Notebook: T4×2, Add Input ×4 (ecup-t3, ozon-code, tabfeats-wed, Output сессии 2) | ~5 мин |
| 5 | вставить ячейки 1-5 отсюда; ячейку 1 и 2 прогнать, глазами: «26 npz», «хранилище готово», якоря ..2025-12-10 | ~7 мин |
| 6 | ячейка 3; через 5-10 мин в ячейке 4 увидеть «warm-старт OK» и первую пару score/tabzero | ~10 мин |
| 7 | Save Version → Save & Run All (или интерактив + ячейка 5) | сессия ~6 ч |
