...
PRIVATE_EV = {                 # E[private] относительно чистой цепочки T3
    "F5_priv": +0.000923,      # ФИНАЛИСТ-1 (28.08): лучший законный паблик 1.6462976 И
                               # лучшая приватная EV — редкий случай, когда совпало
    "F4_priv": +0.000254,      # ФИНАЛИСТ-2
    "F3_priv": +0.000333,      # вытеснен F5 в первом слоте
