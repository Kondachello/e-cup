...
MEASURED: list[tuple[str, str, float]] = [
    ...
    # --- T-серия (tfm4, залив трека 5). T1 в списке нет: точное число не записано
    # ни в одном md ветки — внести, когда трек 5 его сообщит.
    ("T2_tfm4_orth_045", "T2_tfm4_orth_045.csv",           1.6469638837),
